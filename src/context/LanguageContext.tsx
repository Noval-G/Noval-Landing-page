...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'timeline.work.mlsa.desc': 'Supported the livestream program "Boss Take Your Seat" across guest coordination, teaser production, pre-show equipment setup, OBS control, and live comment monitoring. Also contributed to CTM livestreams and "Journey Across the Miles", including field shoots in Portugal, Xinjiang, and Quanzhou, while handling system bugs and hardware troubleshooting to keep production workflows stable.',
    ...
    'resume.experience.desc': 'Handled guest coordination, teaser filming and editing, and pre-show equipment setup for "Boss Take Your Seat", while operating OBS and live comment monitoring during broadcasts. Also supported CTM livestreams and "Journey Across the Miles" through field shooting, backstage editing, system bug handling, and hardware troubleshooting.',
  ...
  zh: {
    ...
    'timeline.work.mlsa.desc': '支援《老細埋位》來賓聯絡、預熱短片拍攝剪輯、直播前器材架設，以及直播中的 OBS 操作與留言監看；同時參與澳門 CTM 直播與《濠行千里》拍攝，處理系統 bug 與硬體排錯，讓現場與製作流程維持穩定運作。',
    ...
    'resume.experience.period': '2025.01 — 2026.03',
    'resume.experience.desc': '負責《老細埋位》來賓聯絡、預熱短片拍攝剪輯與直播前器材架設，直播時操作 OBS 與留言監看；亦支援澳門 CTM 直播及《濠行千里》拍攝，處理系統 bug 與硬體排錯，確保直播與拍攝流程穩定推進。',
