...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'about.desc': 'I am a Digital Multimedia Art & Game Design graduate currently targeting IT support and technical operations roles. My experience spans livestream system setup, OBS control, hardware troubleshooting, computer repair and upgrade planning, video production, and full-stack interactive project development. I learn new tools quickly, solve issues under pressure, and work comfortably across hardware, software, and content workflows.',
    ...
    'collection.item.game.desc': 'A solo UE5 project covering scene assembly, parkour systems, damage logic, level logic, and Niagara effects.',
    'collection.item.game.content': 'XenoVersus was built independently from the ground up in Unreal Engine 5. I handled scene construction, camera transitions, character setup, Niagara effects, damage calculation logic, level-state logic, and a parkour movement system. This project best reflects my ability to combine visual presentation, gameplay logic, and technical implementation in one end-to-end production.',
    ...
    'collection.item.code.desc': 'A solo full-stack AI Werewolf project built with TypeScript, React, Vite, Zustand, Socket.IO, Express, and DeepSeek API.',
    'collection.item.code.content': 'Line or Lie is a one-person project that I designed and implemented end to end. The project uses TypeScript as its core language, React + Vite for the frontend, Zustand for state management, Socket.IO for real-time synchronization, and Node.js + Express for backend game flow and connection management. AI dialogue and role interaction are powered by the DeepSeek API, while shared types keep frontend and backend data aligned. It is the clearest example of my ability to integrate interface design, networking, game logic, and AI behavior into a complete technical product.',
    'collection.item.video.title': 'Video Portfolio',
    'collection.item.video.category': 'Video',
    'collection.item.video.desc': 'Live production support spanning pre-shoot coordination, on-site setup, OBS control, editing, and field shooting.',
    'collection.item.video.content': 'At Macau Live, I supported productions such as "Boss Take Your Seat", CTM livestreams, and "Journey Across the Miles". My work included coordinating interview schedules, filming and editing teaser clips, setting up cameras, computers, and lighting, operating OBS and comment monitoring during livestreams, and handling field shooting and backstage edits in locations including Portugal, Xinjiang, and Quanzhou. This work shows my ability to keep technical setups stable while supporting fast-moving production demands.',
    // Timeline
    ...
    'timeline.work.mlsa.desc': 'Operated the livestream program "Boss Take Your Seat" by coordinating guests, filming and editing teaser content, setting up cameras, computers, and lighting, and running OBS plus live comment monitoring. Also supported CTM livestreams and "Journey Across the Miles", worked on shoots in Portugal, Xinjiang, and Quanzhou, and handled system bugs, hardware troubleshooting, and upgrade planning to keep broadcasts stable.',
    ...
    'resume.role': 'IT Support • Technical Integration',
    'resume.summary': 'Cross-disciplinary technical generalist targeting IT support roles, with hands-on experience in livestream setup, OBS control, hardware troubleshooting, system bug resolution, computer repair and upgrade planning, video production, and full-stack interactive project development. Strong at learning new tools quickly, stabilizing production environments under pressure, and connecting hardware, software, and content workflows into reliable execution.',
    'resume.experience.period': '2025.01 — 2026.03',
    'resume.experience.desc': 'Managed guest coordination, teaser filming and editing, and pre-show setup for "Boss Take Your Seat", while also operating OBS and live comment monitoring during broadcasts. Supported CTM livestreams and "Journey Across the Miles" through field shooting, backstage editing, system bug handling, hardware troubleshooting, and upgrade planning.',
    'resume.project.lineorlie.title': 'Line or Lie | AI Social Deduction Project',
    'resume.project.lineorlie.desc': 'Built a solo full-stack AI Werewolf project using TypeScript, React + Vite, Zustand, Socket.IO, Node.js, Express, shared types, and DeepSeek API integration.',
    'resume.project.xeno.title': 'XenoVersus | UE5 Solo Project',
    'resume.project.xeno.desc': 'Built a solo UE5 project covering scene assembly, camera transitions, character setup, Niagara effects, damage logic, level logic, and parkour systems.',
  ...
  zh: {
    ...
    'about.desc': '我畢業於世新大學數位多媒體設計學系（遊戲設計組），目前以 IT Support 與技術營運方向為求職核心。我的經驗涵蓋直播系統架設、OBS 中控、硬體排錯、電腦維修與升級規劃、影像製作，以及互動專案的全端開發。我學習速度快，能在高壓環境下排解問題，也擅長串接硬體、軟體與內容製作流程，讓整體執行更穩定。',
    ...
    'collection.item.game.desc': '一人完成 UE5 專案，涵蓋場景搭建、跑酷系統、傷害邏輯、關卡判定與 Niagara 特效。',
    'collection.item.game.content': '《XenoVersus》是我獨立從 0 完成的 Unreal Engine 5 專案。我實際負責場景搭建、攝影轉場、人物模型處理、Niagara 特效、傷害計算邏輯、遊戲關卡判斷邏輯，以及跑酷系統搭建。這個專案最能體現我把視覺呈現、玩法設計與技術邏輯整合成完整遊戲體驗的能力。',
    ...
    'collection.item.code.desc': '由我一人設計與開發的全端 AI 狼人殺，整合 TypeScript、React、Socket.IO、Express 與 DeepSeek API。',
    'collection.item.code.content': '《Line or Lie》是由我個人一手設計與開發的 AI 狼人殺專案。這個 project 以 TypeScript 為主要語言，前端使用 React + Vite 建構互動介面，並以 Zustand 管理狀態；即時對戰與遊戲同步透過 Socket.IO 實作，後端則以 Node.js + Express 負責遊戲流程、規則控制與連線管理。AI 對話與角色互動整合 DeepSeek API，並透過 shared 共用型別維持前後端資料一致。這個專案最能體現我在介面、網路同步、遊戲邏輯與 AI 整合上的多技術整合能力。',
    'collection.item.video.title': '影像作品集',
    'collection.item.video.category': '影像製作',
    'collection.item.video.desc': '從前期聯絡、現場架設、OBS 中控到拍攝剪輯，涵蓋直播與外景製作支援。',
    'collection.item.video.content': '我在澳門直播協會參與《老細埋位》、澳門 CTM 直播與《濠行千里》等內容製作，工作內容包含聯絡受訪對象、安排拍攝時間、拍攝與剪輯預熱短片、直播前架設相機、電腦與燈光，以及直播時操作 OBS 與留言監看。我亦曾跟隨拍攝團隊前往葡萄牙、新疆與泉州，負責幕後拍攝與剪輯。這些經驗反映了我在現場技術支援、內容執行與高變動工作流程中的穩定度。',
    // Timeline
    'timeline.title': '旅程',
    ...
    'timeline.work.mlsa.desc': '負責《老細埋位》受訪對象聯絡、預熱短片拍攝與剪輯，並於直播前架設相機、電腦與燈光，直播中操作 OBS 與留言監看；同時支援澳門 CTM 直播與《濠行千里》拍攝，處理電腦系統 bug、硬體排錯、器材配置與升級方案，確保直播與拍攝流程穩定進行。',
    ...
    'resume.role': 'IT Support・技術整合',
    'resume.summary': '以 IT Support 為求職方向的跨域技術整合型人才，具備直播系統架設、OBS 中控、硬體排錯、系統 bug 處理、電腦維修與升級規劃、影像製作，以及互動專案全端開發經驗。學習能力強，能在高壓環境中快速排解問題，並有效串接硬體、軟體與內容流程。',
    'resume.experience.period': '2025.01 — 2026.03',
    'resume.experience.desc': '負責《老細埋位》來賓聯絡、預熱短片拍攝剪輯與直播前器材架設，直播時操作 OBS 與留言監看；亦支援澳門 CTM 直播及《濠行千里》拍攝，處理系統 bug、硬體排錯與升級規劃，維持直播與拍攝流程穩定。',
    'resume.project.lineorlie.title': 'Line or Lie｜AI 社交推理專案',
    'resume.project.lineorlie.desc': '由我一人完成的全端 AI 狼人殺，使用 TypeScript、React + Vite、Zustand、Socket.IO、Node.js、Express、shared types 與 DeepSeek API 整合。',
    'resume.project.xeno.title': 'XenoVersus｜UE5 個人專案',
    'resume.project.xeno.desc': '獨立完成 UE5 專案，涵蓋場景搭建、攝影轉場、人物模型、Niagara 特效、傷害邏輯、關卡判斷與跑酷系統搭建。',
