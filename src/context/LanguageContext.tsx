...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'collection.desc': 'A curated selection of my work in game design, programming, multimedia art, and video production.',
    ...
    'collection.item.code.desc': 'Interactive systems and game logic, including an AI-driven Werewolf experience.',
    'collection.item.code.content': 'One of my most representative programming projects is an AI-driven Werewolf game. I focused on role flow, night-and-day phase control, conversation progression, and the tension of social deduction, allowing AI to actively participate in the match instead of acting as a simple text responder. This project shows how I use programming to connect game rules, dynamic dialogue, and player psychology into a complete interactive experience.',
    ...
    'timeline.work.mlsa.desc': 'Handled digital content operations, social media management, and technical support for live streaming sessions.',
  ...
  zh: {
    ...
    'collection.desc': '在遊戲設計、程式設計、多媒體藝術與影像製作領域的精選創作。',
    ...
    'collection.item.game.desc': '從 2D Unity 動作開發到 3D UE5 獨立開發的蜕變',
    'collection.item.game.content': '我的旅程始於大二時期使用 Unity 打造的 2D 橫向捲軸遊戲，當時與團隊歷時三個月研發了獨創的「蓄力 QTE 魔法系統」。這份熱情延續到了我的畢業製作《XenoVersus》——這是一次最具挑戰性的嘗試，我獨自一人在四個月內沉浸於 Unreal Engine 5 的世界，克服了 C++ 與藍圖交織的技術難關。雖然最終為了技術完整度將對戰模式改為闖關冒險，但這份遺憾與成長，是我在技術研發中最真實、也最珍貴的風景。',
    ...
    'collection.item.code.desc': '以互動系統與 AI 驅動玩法為核心，其中包含一款 AI 驅動的狼人殺遊戲。',
    'collection.item.code.content': '我其中一個很有代表性的程式專案，是一款由 AI 驅動的狼人殺遊戲。我著重在角色流程、白天與夜晚迴圈、對話推進與遊戲節奏控制，讓 AI 不只是回應文字，而是能實際參與社交推理與局勢變化。這個專案體現了我如何透過程式設計，把遊戲規則、互動敘事與玩家心理壓力整合成完整體驗。',
    ...
    'timeline.work.mlsa.desc': '負責新媒體內容運營、內容創作及直播技術支援。管理社交媒體平台並優化數位互動。',
