...
export default function About() {
  ...
  const traits = [
    {
      icon: Zap,
      title: t('about.trait.learner'),
      text: t('about.trait.learner.desc')
    },
    {
      icon: Users,
      title: t('about.trait.team'),
      text: t('about.trait.team.desc')
    }
  ];
    ...
    <section id="about" className="py-24 px-6 md:px-12 bg-white overflow-hidden">
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <h2 className="text-sm font-bold tracking-widest uppercase text-accent mb-4">{t('about.badge')}</h2>
            <h3 className="text-4xl md:text-5xl font-bold mb-8 leading-tight">
              {t('about.title.part1')} <span className="text-muted">{t('about.title.part2')}</span>
            </h3>
          ...
          >
            <div className="flex items-center gap-3 mb-8">
              ...
              <h4 className="text-xl font-bold">{t('about.languages')}</h4>
            </div>
